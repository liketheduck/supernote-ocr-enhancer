...
**Key insight**: Files with TYPE='0' are still fully searchable if they have RECOGNTEXT data. We tested this with Marriage.note and Common Book.note - both have TYPE='0' and are searchable.
